...
//       <div className="book-room-form-all">
...
//     const [numberOfRooms, setNumberOfRooms] = useState(1); // Added state for number of rooms
...
//       alert('Check-out date must be after check-in date./चेक-आउट तिथि चेक-इन तिथि के बाद की होनी चाहिए।');
//       setIsLoading(false);
...
//             checkInTime: format(checkInDate, 'dd/MM/yyyy'), // Changed key to checkInTime
//             checkOutTime: format(checkOutDate, 'dd/MM/yyyy'), // Changed key to checkOutTime
//             fullName: customerName, // Changed key to fullName
//             moNo: mobileNumber, // Changed key to moNo
//             location: location,
//             customerType: userType, // Changed key to customerType
//             noOffRoom: numberOfRooms, // Changed key to noOffRoom
//             totalGuest: numberOfGuests, // Changed key to totalGuest
//             // status: status,
//         };
    
//         try {
//             // Send data to Google Apps Script
//             // await fetch('https://script.google.com/macros/s/AKfycbzI-sMBJ0ZO549H2TL1zaw3kRSaEe-JBWZozgnlbqLJCyQWd4LiMFlccf2Zha3WSRmS/exec', {
...
//                 },
//                 body: JSON.stringify(newCustomer), // Convert data to JSON string
//                 mode:'no-cors'
...
//                               <td>
//                                   <select id="roomType" value={userType} onChange={(e) => setUserType(e.target.value)} required className="add-booking-select">
...
//                 method: 'POST',//https://script.google.com/macros/s/AKfycbzAES6vIe7PRtls0bQfLxBclgoekMfxPEJpyl6yac1t3W9lIg-BapBvojd_HDEd35pR/exec
//                 headers: {
//                     'Content-Type': 'application/json',
//                 },
//                 body: JSON.stringify(newCustomer),
